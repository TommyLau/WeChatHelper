...
@class ContactProfileHeader, MMAvatarImageView, MMCTTextView, MMDivider, MMImageView, MMTextField, WCContactData;
...
@interface MMProfileHeaderView : NSView <IContactMgrExt>
{
    ...
    MMTextField *_fakeNickNameText;
    MMTextField *_wechatIdField;
    MMImageView *_genderImgView;
...
@property(retain, nonatomic) MMImageView *genderImgView; // @synthesize genderImgView=_genderImgView;
@property(retain, nonatomic) MMTextField *wechatIdField; // @synthesize wechatIdField=_wechatIdField;
@property(retain, nonatomic) MMTextField *fakeNickNameText; // @synthesize fakeNickNameText=_fakeNickNameText;
