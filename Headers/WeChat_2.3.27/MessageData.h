...
@class AppProductItem, DownloadVideoReportData, FavoritesItem, MMTranslateResult, MessageDataPackedInfo, NSArray, NSData, NSMutableArray, NSString, SendImageInfo, UploadVideoReportData, WCPayInfoItem;
