...
@class CAShapeLayer, MMBatchExportViewWindow, MMButton, MMChatCollectionViewController, MMChatFTSSearchLogic, MMChatManagerDataSource, MMChatManagerEventView, MMMessageCellView, MMMessageScrollView, MMMessageSendLogic, MMMessageTableItem, MMTableView, MMTextField, MMTimer, MMView, NSButton, NSImageView, NSMutableArray, NSProgressIndicator, NSString, NSTextField, NSView, WCContactData;
...
@interface MMChatManagerDetailViewController : NSViewController <NSTableViewDataSource, NSTableViewDelegate, MMTableViewDelegate, MMMessageCellViewDelegate, MMViewerWindowDelegate, IContactMgrExt, MMCollectionDelegate, MessageBatchExportMgrExt>
{
    ...
    MMChatManagerEventView *_globalOpenChatView;
    ...
    MMChatManagerEventView *_all;
    MMChatManagerEventView *_photo;
    MMChatManagerEventView *_file;
    MMChatManagerEventView *_link;
...
@property __weak MMChatManagerEventView *link; // @synthesize link=_link;
@property __weak MMChatManagerEventView *file; // @synthesize file=_file;
@property __weak MMChatManagerEventView *photo; // @synthesize photo=_photo;
@property __weak MMChatManagerEventView *all; // @synthesize all=_all;
...
@property __weak MMChatManagerEventView *globalOpenChatView; // @synthesize globalOpenChatView=_globalOpenChatView;
...
@property __weak MMChatManagerEventView *back; // @synthesize back=_back;
