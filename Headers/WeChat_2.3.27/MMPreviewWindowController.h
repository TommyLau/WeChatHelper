...
@class MMButton, MMCustomDisableButton, MMCustomDivider, MMDragEventView, MMPreviewEventView, MMPreviewPageController, MMPreviewToggleRestoreButton, MMPreviewViewController, MMPreviewWindow, MMTimer, MMView, NSArray, NSButton, NSImageView, NSString, NSTextField, NSTrackingArea, NSView, NSVisualEffectView;

@interface MMPreviewWindowController : NSWindowController <AccountServiceExt, NSWindowDelegate, NSSharingServiceDelegate, MMPreviewWindowDelegate, NSMenuDelegate, NSPageControllerDelegate>
{
...
@property(retain, nonatomic) MMCustomDivider *secondDivider; // @synthesize secondDivider=_secondDivider;
...
@property(retain, nonatomic) MMCustomDivider *firstDivider; // @synthesize firstDivider=_firstDivider;
