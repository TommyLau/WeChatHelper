...
- (NSDictionary *)onBlockMonitor:(WCBlockMonitorMgr *)arg1 getUserInfoForFPSDumpWithDumpType:(unsigned long long)arg2;
...
- (void)onBlockMonitor:(WCBlockMonitorMgr *)arg1 filter:(unsigned long long)arg2;
