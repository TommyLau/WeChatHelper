...
@class MMContactListContactRowView, MMContactListLogic, MMDragEventView, MMSearchField, MMSearchViewController, MMTableView, MMTimer, NSArray, NSObject<OS_dispatch_queue>, NSString;
