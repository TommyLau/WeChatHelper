...
@class FavoritesItem, MMDivider, MMFavBrowseDetailReportData, MMPreviewTitleButton, MMWindow, MessageData, NSButton, NSString, NSTextField, NSView, WeNoteArticleToolBar, WeNoteDetailViewController;
