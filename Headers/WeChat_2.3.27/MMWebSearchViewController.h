...
@class MMCustomDivider, MMCustomSearchField, MMImageView, MMTableView, MMTextField, MMWebSearchSuggestViewController, NSArray, NSProgressIndicator, NSString, RBLPopover;

@interface MMWebSearchViewController : MMViewController <NSTabViewDelegate, NSTableViewDataSource, NSSearchFieldDelegate, MMTableViewDelegate, NSControlTextEditingDelegate, MMWebSearchSuggestVCDelegate, MMSuggestionPopoverBackgrounViewDelegate>
{
    BOOL _isSearching;
    BOOL _noMoreResults;
