...
@class MMCustomDivider, MMDragEventView, MMDraggingOverlayView, MMFavoriteCollectionView, MMFavoritesCollectionData, MMFavoritesDetailBaseCell, MMTimer, NSArray, NSMutableDictionary, NSString, NSTextField, NSView;
