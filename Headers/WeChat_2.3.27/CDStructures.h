...
struct C2CDownloadRequest {
    ...
    void *video_callback;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> filekey;
    void *user_context;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> arg_info;
    ...
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> savepath;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> aeskey;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> fileid;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> filemd5;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> statefile;
    int limit_rate;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> bigfile_signture;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> msg_extra;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> videofileid;
    _Bool isstoragemode;
    _Bool issmallvideo;
    int islargesvideo;
    _Bool isautostart;
    ...
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> fakeBigfileSignature;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> fakeBigfileSignatureAeskey;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> url;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> host;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> referer;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> signal_quality;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> sns_scene;
    unsigned long long sns_decrypt_key;
    unsigned int concurrent_count;
    unsigned int max_http_redirect_count;
    struct vector<std::__1::basic_string<char>, std::__1::allocator<std::__1::basic_string<char>>> oc_iplist;
    int oc_iplist_source;
    struct vector<std::__1::basic_string<char>, std::__1::allocator<std::__1::basic_string<char>>> dc_iplist;
    int dc_iplist_source;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> custom_request_header;
    ...
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> bakup_url;
    ...
    int msg_type_;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> feed_id_;
    int feed_pic_count_;
...
struct ProxyInfo {
    int type;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> host;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> ip;
    unsigned short port;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> username;
    struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> password;
};
...
struct tagAVQualityReportInfo {
    ...
    struct tagVCodec2HWEngineReport _field320;
};
