...
@class CAShapeLayer, MMCTTextView, MMCircleActionButton, MMCircularProgressView, MMTextField, NSImageView, NSString, NSView, TKStateMachine;

@interface MMFileMessageCellView : MMMessageCellView <IMMMessageFileServiceExt, MessageBatchExportMgrExt, IMessageExt>
{
