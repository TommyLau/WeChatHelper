...
@class FavoritesItem, FavoritesItemDataField, MMFavoriteItemViewerWindow, MMTableView, MMTextView, MessageData, NSMutableDictionary, NSString, NSTableCellView;
...
@interface MMChatLogDetailViewController : NSViewController <NSTabViewDelegate, NSTableViewDataSource, MMChatLogCellViewDelegate, MMTableViewDelegate, MMChatLogRecordCellViewDelegate, MMViewerWindowDelegate>
{
    ...
    MMFavoriteItemViewerWindow *_weakFavItemViewerWindow;
...
@property(nonatomic) __weak MMFavoriteItemViewerWindow *weakFavItemViewerWindow; // @synthesize weakFavItemViewerWindow=_weakFavItemViewerWindow;
